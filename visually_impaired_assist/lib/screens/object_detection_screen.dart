  ...
  Future<void> uploadImage(File image) async {
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('$ip/detect'), // Adjust your backend IP
      );
      ...
      if (response.statusCode == 200) {
        ...
        final labels = (data as List).map((e) => e['label']).join(', ');
        setState(() => _result = "Detected: $labels");
      ...
      appBar: AppBar(
        ...
        title: const Row(
          children: [
            ...
            SizedBox(width: 8.0),
            Text('Object Detection', style: TextStyle(color: Colors.white)),
          ],
        ),
